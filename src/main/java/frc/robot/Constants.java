...
public final class Constants {
  ...
  public static class AutoConstants {
    public static final Pose2d redStart = new Pose2d(0, 0, new Rotation2d(0));
    public static final Pose2d blueStart = new Pose2d(Math.PI, Math.PI, new Rotation2d(Math.PI));
  }
