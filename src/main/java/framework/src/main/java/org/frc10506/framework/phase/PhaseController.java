...
/**
 * A state machine responsible for controlling robot phase. This class is used
 * in the {@link PhaseDrivenRobot}, which handles the transition between phases
 * when mode enter/exit methods are called.
 */
